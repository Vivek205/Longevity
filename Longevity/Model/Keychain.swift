...
struct KeychainConfiguration {
    static let serviceName = "io.rejuve.keychainItem"
...
struct KeyChain {
    ...
    mutating func renameAccount(_ newAccountName: String) throws {
        ...
        let query = KeyChain.keychainQuery(withService: service, account: self.account, accessGroup: accessGroup)
        let status = SecItemUpdate(query as CFDictionary, attributesToUpdate as CFDictionary)
    ...
    static func keychainItems(forService service: String, accessGroup: String? = nil) throws -> [KeyChain] {
        ...
        // Create a `KeyChain` for each dictionary in the query result.
