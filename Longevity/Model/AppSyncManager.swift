...
class AppSyncManager  {
    ...
    fileprivate let defaultInsights = [UserInsight(name: .overallInfection,
                                                   ...
                                                   userInsightDescription: "How likely you risk having COVID right now.  This factors all your risk and biosignals",
                                                   defaultOrder: 0,
                                                   details: Details(lastLogged: nil, history: nil, riskLevel: nil, trending: nil, sentiment: nil,
                                                                    confidence: Confidence(value: "",
                                                                                           confidenceDescription: ""),
                                                                    histogram: Histogram(histogramDescription: "Your risk over the time of your data and biosignals."), submissions: nil),
                                                   isExpanded: false),
                                       UserInsight(name: .exposure,
                                                   text: "Severity Infection",
                                                   userInsightDescription: "This estimates the risk of how bad the infection will be if you get COVID.",
                                                   defaultOrder: 1,
                                                   details: Details(lastLogged: nil, history: nil, riskLevel: nil, trending: nil, sentiment: nil,
                                                                    confidence: Confidence(value: "",
                                                                                           confidenceDescription: ""),
                                       ...
                                       UserInsight(name: .distancing,
                                                   ...
                                                   userInsightDescription: "How likely you have COVID now based on your biosignals from connected wearable devices or health trackers.",
                                                   defaultOrder: 2,
                                                   details: Details(lastLogged: nil, history: nil, riskLevel: nil, trending: nil, sentiment: nil,
                                                                    confidence: Confidence(value: "",
                                                                                           confidenceDescription: ""),
                                                                    histogram: Histogram(histogramDescription: "Your risk over the time of your data and biosignals."), submissions: nil),
                                                   isExpanded: false),
                                       UserInsight(name: .risk,
                                                   text: "Life Style Infection",
                                                   userInsightDescription: "How likely the risk of getting COVID based on your lifestyle and social distancing practices.",
                                                   defaultOrder: 3,
                                                   details: Details(lastLogged: nil, history: nil, riskLevel: nil, trending: nil, sentiment: nil,
                                                                    confidence: Confidence(value: "",
                                                                        confidenceDescription: ""),
